...
protocol Day5_RenderDestinationProvider {
...
class Day5_Renderer {
    ...
    var renderDestination: Day5_RenderDestinationProvider
    ...
    init(session: ARSession, metalDevice device: MTLDevice, renderDestination: Day5_RenderDestinationProvider) {
    ...
    func loadMetal() {
        ...
        let capturedImageVertexFunction = defaultLibrary.makeFunction(name: "Day5_capturedImageVertexTransform")!
        let capturedImageFragmentFunction = defaultLibrary.makeFunction(name: "Day5_capturedImageFragmentShader")!
        ...
        let anchorGeometryVertexFunction = defaultLibrary.makeFunction(name: "Day5_anchorGeometryVertexTransform")!
        let anchorGeometryFragmentFunction = defaultLibrary.makeFunction(name: "Day5_anchorGeometryFragmentLighting")!
        ...
        let compositeImageVertexFunction = defaultLibrary.makeFunction(name: "Day5_compositeImageVertexTransform")!
        let compositeImageFragmentFunction = defaultLibrary.makeFunction(name: "Day5_compositeImageFragmentShader")!
    ...
    private func loadTexture() {
        ...
        bgTexture = try! textureLoader.newTexture(
            name: "day5",
            scaleFactor: 2.0, // TODO: ここ決め打ちしているが正しい値を渡すべき
            bundle: nil)
    }
