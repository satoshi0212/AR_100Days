...
protocol Day10_RenderDestinationProvider {
...
class Day10_Renderer {
    ...
    var renderDestination: Day10_RenderDestinationProvider
    ...
    init(session: ARSession, metalDevice device: MTLDevice, renderDestination: Day10_RenderDestinationProvider) {
    ...
    func loadMetal() {
        ...
        let fogVertexFunction = defaultLibrary.makeFunction(name: "Day10_fogVertexTransform")!
        let fogFragmentFunction = defaultLibrary.makeFunction(name: "Day10_fogFragmentShader")!
